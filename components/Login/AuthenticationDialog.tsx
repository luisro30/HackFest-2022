      ...
      <Transition appear show={isOpen} as={Fragment}>
        ...
        >
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="my-8 inline-block w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 align-middle shadow-xl transition-all dark:bg-white-800">
                <span className="mx-auto flex w-[140px] ">
                  <Logo />
                </span>
                <Tab.Group>
                  <Tab.List className="mt-4 flex overflow-hidden rounded-lg bg-black-100 dark:text-gray-500">
                    <Tab
                      className={({ selected }) =>
                        clsx(
                          "w-full py-2.5 font-medium leading-5",
                          selected ? "bg-green-700 text-black" : ""
                        )
                      }
                    >
                      Sign In
                ...
                <div className="my-4 flex items-center">
                  <span className="block h-0.5 w-full bg-black-400"></span>
...
const SignInForm = () => {
  return (
    <div className="rounded-tr-4xl px-10 pt-4 pb-4">
      ...
      <a
        href="#"
        className="mt-4 block transition-all duration-150 hover:font-semibold hover:text-indigo-800 hover:underline dark:text-gray-300 dark:hover:text-black"
      >
  ...
  return (
    <div className="rounded-tr-4xl px-10 pt-4 pb-4">
      ...
      <p className="mt-4 text-sm">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis ab quam
        odit illo earum cumque accusamus corporis reprehenderit, doloribus
        commodi nihil veritatis quia, libero possimus soluta rem ex, delectus
        est!e agreed to our{" "}
        <a
          href=""
